...
class FavoritesResponseModelByReda {
  final bool hasErrors;
  final dynamic statusCode;
  final dynamic message;
  final List<FavoriteItem> data;

  FavoritesResponseModelByReda({
    this.hasErrors,
    this.statusCode,
    this.message,
    this.data,
  ...
  factory FavoritesResponseModelByReda.fromRawJson(String str) =>
      FavoritesResponseModelByReda.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FavoritesResponseModelByReda.fromJson(Map<String, dynamic> json) =>
      FavoritesResponseModelByReda(
...
class FavoriteItem {
  ...
  factory FavoriteItem.fromRawJson(String str) =>
      FavoriteItem.fromJson(json.decode(str));
  ...
  factory FavoriteItem.fromJson(Map<String, dynamic> json) => FavoriteItem(
        ...
        searchItemName:
            json["searchItemName"] == null ? null : json["searchItemName"],
        ...
        fkItemTypeId:
            json["fkItemTypeId"] == null ? null : json["fkItemTypeId"],
        fkFixedAssetId: json["fkFixedAssetId"],
        reorderQuantity:
            json["reorderQuantity"] == null ? null : json["reorderQuantity"],
        maxOrderQuantity:
            json["maxOrderQuantity"] == null ? null : json["maxOrderQuantity"],
        maxStockQuantity:
            json["maxStockQuantity"] == null ? null : json["maxStockQuantity"],
        allowedExcessRate: json["allowedExcessRate"] == null
            ? null
            : json["allowedExcessRate"],
        expiryDays: json["expiryDays"] == null ? null : json["expiryDays"],
        purchaseDiscount:
            json["purchaseDiscount"] == null ? null : json["purchaseDiscount"],
        purchaseDiscountRate: json["purchaseDiscountRate"] == null
            ? null
            : json["purchaseDiscountRate"],
        vendorDiscount:
            json["vendorDiscount"] == null ? null : json["vendorDiscount"],
        vendorDiscountRate: json["vendorDiscountRate"] == null
            ? null
            : json["vendorDiscountRate"],
        ...
        stopPurchase:
            json["stopPurchase"] == null ? null : json["stopPurchase"],
        stopTransfer:
            json["stopTransfer"] == null ? null : json["stopTransfer"],
        stopInventory:
            json["stopInventory"] == null ? null : json["stopInventory"],
        ...
        showStockInClosure: json["showStockInClosure"] == null
            ? null
            : json["showStockInClosure"],
        showSalesInClosure: json["showSalesInClosure"] == null
            ? null
            : json["showSalesInClosure"],
        ...
        itemBarCode: json["itemBarCode"] == null
            ? null
            : List<dynamic>.from(json["itemBarCode"].map((x) => x)),
        itemsPackages: json["itemsPackages"] == null
            ? null
            : List<dynamic>.from(json["itemsPackages"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "allowedExcessRate":
            allowedExcessRate == null ? null : allowedExcessRate,
        ...
        "purchaseDiscountRate":
            purchaseDiscountRate == null ? null : purchaseDiscountRate,
        "vendorDiscount": vendorDiscount == null ? null : vendorDiscount,
        "vendorDiscountRate":
            vendorDiscountRate == null ? null : vendorDiscountRate,
        ...
        "showStockInClosure":
            showStockInClosure == null ? null : showStockInClosure,
        "showSalesInClosure":
            showSalesInClosure == null ? null : showSalesInClosure,
        ...
        "itemBarCode": itemBarCode == null
            ? null
            : List<dynamic>.from(itemBarCode.map((x) => x)),
        "itemsPackages": itemsPackages == null
            ? null
            : List<dynamic>.from(itemsPackages.map((x) => x)),
        "cartProducts": cartProducts == null
            ? null
            : List<dynamic>.from(cartProducts.map((x) => x)),
      };
}
